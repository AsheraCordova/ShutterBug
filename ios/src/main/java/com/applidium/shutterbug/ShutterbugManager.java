...
public class ShutterbugManager implements ImageCacheListener, ShutterbugDownloaderListener {
    ...
    public void download(String url, Drawable placeHolder, final ShutterbugImageCallBack imageView) {
        download(url, placeHolder, imageView, -1, -1);
    }

    public void download(String url, Drawable placeHolder, final ShutterbugImageCallBack imageView, int desiredHeight, int desiredWidth) {
    ...
    public void cancel(ShutterbugImageCallBack imageView) {
    ...
    private static class ImageManagerListener implements ShutterbugManagerListener {
        private ShutterbugImageCallBack mImageView;

        public ImageManagerListener(ShutterbugImageCallBack imageView) {
